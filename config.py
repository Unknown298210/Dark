...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002010997108"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002104237587"))
...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6934514903:AAHLVkYqPEwyIZiyqEhJocOrjDYwTk9ue8Y") 
...
OWNER_TAG = os.environ.get("OWNER_TAG", "hskdashing_X_Owners")
...
# SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "1764633c10720d858365faa20245779230b31303")
...
#UPI ID
UPI_ID = os.environ.get("UPI_ID", "Ask To Owner For Qr Code")
#UPI QR CODE IMAGE
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7350721166 6943832981").split()):
        ADMINS.append(int(x))
except ValueError:
