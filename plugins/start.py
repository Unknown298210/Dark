    ...
    if len(message.text) > 7:
        for i in range(1):
            ...
            try:
                ...
                await message.reply(f"𝚃𝚘 𝙶𝚎𝚝 𝚃𝚑𝚎 𝙲𝚘𝚗𝚝𝚎𝚗𝚝 𝚈𝚘𝚞 𝙽𝚎𝚎𝚍 𝚃𝚘 𝙶𝚘 𝚃𝚑𝚛𝚘𝚞𝚐𝚑 𝙰 𝚂𝚒𝚗𝚐𝚕𝚎 𝙰𝚍𝚟𝚎𝚛𝚝𝚒𝚜𝚎𝚖𝚎𝚗𝚝 𝙿𝚊𝚐𝚎. 📰 {get_exp_time(VERIFY_EXPIRE)}\n 𝚆𝚎 𝚆𝚒𝚕𝚕 𝚃𝚊𝚔𝚎 𝙾𝚗𝚕𝚢 2 𝙼𝚒𝚗𝚜 𝙾𝚏 𝚈𝚘𝚞𝚛. 𝙸𝚏 𝚈𝚘𝚞 𝙳𝚘𝚗'𝚝 𝙷𝚘𝚠 𝚃𝚘 𝚃𝚊𝚔𝚎 𝚃𝚘𝚔𝚎𝚗 𝙲𝚕𝚒𝚌𝚔 𝙾𝚗 𝙷𝚘𝚠 𝚃𝚘 𝙾𝚙𝚎𝚗 𝙻𝚒𝚗𝚔𝚜 𝙵𝚘𝚛 𝚃𝚘𝚝𝚞𝚛𝚒𝚊𝚕 𝚅𝚒𝚍𝚎𝚘.\n\n {get_exp_time(VERIFY_EXPIRE)}𝚃𝚘 𝙰𝚟𝚘𝚒𝚍 𝚃𝚊𝚔𝚒𝚗𝚐 𝙰𝚍𝚟𝚎𝚛𝚝𝚒𝚜𝚎𝚖𝚎𝚗𝚝 𝙾𝚛 𝙰𝚗𝚢 𝚀𝚞𝚎𝚛𝚒𝚎𝚜 𝙰𝚋𝚘𝚞𝚝 𝙱𝚞𝚢𝚒𝚗𝚐 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 𝙼𝚎𝚖𝚋𝚎𝚛𝚜𝚑𝚒𝚙 𝙿𝚕𝚊𝚗 ❣️𝙲𝚘𝚗𝚝𝚊𝚌𝚝:- @Heaven_X_Owners.", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
            return
